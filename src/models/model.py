...
from src.models.modules.abstract_modules.base_autoencoder import BaseVQVAE
from src.models.modules.autoencoder import Encoder, Decoder
from src.models.modules.loss.loss import VQLPIPSWithDiscriminator, VQLPIPS
from src.models.modules.vector_quantizers import VectorQuantizer, EMAVectorQuantizer, GumbelVectorQuantizer, \
...
class VQVAE(BaseVQVAE, pl.LightningModule):
    ...
    def test_step(self, images, _):
        ...
        # print(f"input shape on {self.device}: {images.shape}")
        ...
        # print(f"recon shape on {self.device}: {reconstructions.shape}")
